...
Click <a href="https://github.com/w4tchd0gs/esp8266_deauther/wiki/Installation">here</a> for the installation tutorial.<br>
  Click <a href="https://github.com/w4tchd0gs/esp8266_deauther/releases">here</a> for the .bin files.<br><br>
Support the development of this project by purchasing one of the <a href="https://github.com/w4tchd0gs/esp8266_deauther/wiki/Supported-Devices">official deauther boards</a>
</b>!
</p>
...
- Added [PacketMonitor](https://github.com/w4tchd0gs/PacketMonitor) to display UI
- Deauth detection when scanning
- RGB LED support for a quick indication what the device is doing (attacking, scanning, ...)
- Better documentation on the new [wiki](https://github.com/w4tchd0gs/esp8266_deauther/wiki)
...
Use it only against your own networks and devices or get permissions before testing other's devices!  
